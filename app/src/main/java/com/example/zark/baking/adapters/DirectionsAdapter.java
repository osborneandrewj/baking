...
public class DirectionsAdapter
    ...
    public class DirectionsAdapterViewHolder extends RecyclerView.ViewHolder implements
        ...
        public DirectionsAdapterViewHolder(View view) {
            ...
            stepLayout = view.findViewById(R.id.direction_step_view);
            stepNumberTextView = view.findViewById(R.id.tv_step_number);
            descriptionTextView = view.findViewById(R.id.tv_step_description);
